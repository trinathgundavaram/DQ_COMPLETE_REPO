...
gre/executor.py::execute_rule() once per rule. Every rule commits its own
findings independently -- this file only ever decides run ORDER, never
commit/rollback.
"""
...
from gre.rules import load_rules
from gre.executor import execute_query, execute_dml, execute_rule, _log_error, _log_attempt
